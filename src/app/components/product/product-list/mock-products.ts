...
export function generateMusicProducts(): Product[] {
    const basePath = "src\assets\images\MUSIC";
    const musicProducts: Product[] = [
      new Product(
        ...
        'Specifications: 6 strings, wooden body, steel strings',
      ...
      new Product(
        ...
        'Specifications: 88 keys, weighted keys, multiple sound options',
        ProductCategories.MUSIC
      ),
      new Product(
        '3',
        ...
        'Specifications: Bluetooth, noise cancellation, 20 hours battery life',
        ProductCategories.MUSIC
      ),
